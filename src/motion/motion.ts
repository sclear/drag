...
interface ImotionType {
    [key: string]: ImoveFn
}
interface Imotion {
    MotionType: ImotionType
    addMotion(type: string, fn: ImoveFn): void
    removeMotion(type: string): void
    update(type: string, e: any, dragObj: any, point: any): void
}
...
class Motion implements Imotion {
    ...
    public addMotion(type: string, fn: ImoveFn) {
        this.MotionType[type] = fn
    }
    public removeMotion(type: string) {
        delete this.MotionType[type]
    }
    public update(type: string, e: any, dragObj: any, point: any) {
        this.MotionType[type].call(this, e, dragObj, point)
    }
}

let elmentMotion = new Motion()
elmentMotion.addMotion('move', function (e: any, dragObj: any, point: any) {
    let dis = {
...
elmentMotion.addMotion('top', function (e: any, dragObj: any, point: any) {
    // 求旋转图像Tm
...
elmentMotion.addMotion('bottom', function (e: any, dragObj: any, point: any) {
    // 求旋转图像Tm
    let rotateCurrentPos = getRotatedPoint({
        x: e.clientX - point.section.x,
        y: e.clientY - point.section.y,
...
elmentMotion.addMotion('left', function (e: any, dragObj: any, point: any) {
    // 求旋转图像Tm
    let rotateCurrentPos = getRotatedPoint({
        x: e.clientX - point.section.x,
        y: e.clientY - point.section.y,
...
elmentMotion.addMotion('right', function (e: any, dragObj: any, point: any) {
    // 求旋转图像Tm
    let rotateCurrentPos = getRotatedPoint({
        x: e.clientX - point.section.x,
        y: e.clientY - point.section.y,
...
elmentMotion.addMotion('rotate', function (e: any, dragObj: any, point: any) {
    point.rotateCurrent = {
...
elmentMotion.addMotion('topLeft', function (e: any, dragObj: any, point: any) {
    point.centerPos = {
    ...
    let rotateLeftTopPoint = getRotatedPoint(newLeftTopPoint, point.centerPos, point.initAngle)
...
elmentMotion.addMotion('topRight', function (e: any, dragObj: any, point: any) {
    point.centerPos = {
...
elmentMotion.addMotion('bottomLeft', function (e: any, dragObj: any, point: any) {
    point.centerPos = {
    ...
    let rotatedLeftBottomPoint = getRotatedPoint(newLeftBottomPoint, point.centerPos, point.initAngle)
    point.centerPos = {
...
elmentMotion.addMotion('bottomRight', function (e: any, dragObj: any, point: any) {
    point.centerPos = {
